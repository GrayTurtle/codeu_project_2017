...
public final class NetworkCode {
  ...
  public static final int
      ...
      RELAY_WRITE_RESPONSE = 30,
  	  CHECK_USER_REQUEST = 31,
  	  CHECK_USER_RESPONSE = 32,
  	  GET_USER_MESSAGE_COUNT_REQUEST = 33,
  	  GET_USER_MESSAGE_COUNT_RESPONSE = 34,
  	  UPDATE_MESSAGE_COUNT_REQUEST = 35,
  	  UPDATE_MESSAGE_COUNT_RESPONSE = 36,
  	  GET_MESSAGE_BY_ID_REQUEST = 37,
  	  GET_MESSAGE_BY_ID_RESPONSE = 38;
}
